		...
		<div className="w-full flex justify-center mt-2">
			<Alert className="text-left border-blue-200 bg-blue-50 text-blue-800 dark:border-blue-800 dark:bg-blue-950/30 dark:text-blue-200 [&>svg]:text-blue-600 dark:[&>svg]:text-blue-400">
				...
				<AlertDescription className="inline text-foreground">
					Weekview is an independent tool and is not officially affiliated with
					or endorsed by UiTM. Please use this feature responsibly and always
					confirm your timetable with official sources such as iCress or
					myStudent. The data provided is based on UiTM iCress but{" "}
