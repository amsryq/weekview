...
export const MOCK_COURSES = [
	{
		...
		campusCode: "B",
		facultyCode: "CS",
		__internal: { path: "mock/CS220" },
	},
	{
		code: "CS230",
		campusCode: "B",
		facultyCode: "CS",
		__internal: { path: "mock/CS230" },
	},
	{
		code: "CS250",
		campusCode: "B",
		facultyCode: "CS",
		__internal: { path: "mock/CS250" },
	},
	{
		code: "CS260",
		campusCode: "B",
		facultyCode: "CS",
		__internal: { path: "mock/CS260" },
	},
	{
		code: "MAT183",
		campusCode: "B",
		facultyCode: "CS",
		__internal: { path: "mock/MAT183" },
	},
	{
		code: "PHY310",
		campusCode: "B",
		facultyCode: "CS",
		__internal: { path: "mock/PHY310" },
	},
];
